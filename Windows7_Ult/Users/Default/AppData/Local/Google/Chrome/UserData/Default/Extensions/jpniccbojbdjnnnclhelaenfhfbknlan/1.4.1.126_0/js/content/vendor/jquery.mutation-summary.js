...
(function($, global) {
    ...
    JqueryMutationSummary.prototype = {
        ...
        ,
        pause: function(callback, observeOwnChanges, queries) {
            // Pass as reference to inner function
            var summaries = this.options.mutationSummaries;
        ...
        ,
        resume: function(callback, observeOwnChanges, queries) {
            // Pass as reference to inner function
            var summaries = this.options.mutationSummaries;
    ...
    JqueryMutationSummaryInner.prototype = {
        ...
        getCallbackWrapper: function() {
            ...
            function callbackWrapper(summaries) {
                ...
                self.originalCallback(summaries);
            }
        ...
        resume: function() {
            this.pausedSemaphore --;
            if (this.pausedSemaphore < 0) {
                this.pausedSemaphore = 0;
            }
            if (this.pausedSemaphore == 0) {
