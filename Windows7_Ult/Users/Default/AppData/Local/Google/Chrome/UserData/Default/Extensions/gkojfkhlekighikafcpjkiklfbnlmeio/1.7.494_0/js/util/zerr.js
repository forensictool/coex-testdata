...
(function(){
var define, process, deps = ['underscore', '/util/array.js', '/util/date.js',
    '/util/util.js', '/util/sprintf.js', '/util/rate_limit.js',
    '/util/escape.js'];
var is_node = typeof module=='object' && module.exports;
var is_browserify = is_node && typeof self=='object';
if (!is_node)
{
    define = self.define;
    process = {env: {}};
...
define(deps, function(_, array, date, zutil, sprintf, rate_limit, zescape, $){
var E, _zerr;
var env = process.env;
...
var enable_log_buffer = function(){
    if (env.LOG_BUFFER!==undefined && !+env.LOG_BUFFER)
        return;
